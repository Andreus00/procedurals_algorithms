...
# ./bin/yscene render outs/02_displacement/displacement.json --output out/02_voro_displacement_1_1.jpg --samples 25 --resolution 720
./bin/yscene render outs/03_hair1/hair1.json --output out/03_hair1.jpg --samples 25 --resolution 720
